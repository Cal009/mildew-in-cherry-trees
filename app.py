...
from app_pages.page_mildew_visualizer import page_mildew_visualizer
...
app.add_page("Mildew Visualiser", page_mildew_visualizer)
app.add_page("Mildew Detection", page_mildew_detector)
